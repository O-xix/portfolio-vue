...
message.value = 'Invalid login credentails';
        }else{
...
<template>
    <div class="main-container">
        <div class="h-screen items-center justify-center flex flex-col">
            ...
            <button class="h-16 w-64 border-2 bg-[#0078ff] text-center py-4 font-bold font-xl text-white" type="submit">LOGIN</button>
        </form>
            <div class="text-black inline-block px-4 py-4">Don't have an account ? <RouterLink class="inline text-[#0000ff]" to="">Register now</RouterLink></div>
